#!/bin/bash
# Locator v1.0
# Coded by: shubhamggosai (You dont become a coder by just changing the credits)
# Github: https://github.com/shubhamggosai/Locate
...
printf "\n"
printf "\e[1;93m :::\e[0m\e[1;77m Coded by: @shubhamggosai\e[0m\n"
